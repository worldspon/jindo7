...
var myqContent = document.querySelector('.myq-content');
var myqContentWrap = document.querySelector('.myq-content-wrap');
...
firstLoadAsync(myqUrl, 1); // 처음 버튼 클릭시 첫 페이지로
...
function firstPageLoad(data, viewPage) {
  ...
  if (contentLength <= maxContent) {
    for (var i = 0; i < contentLength; i++) {
      tempHtml += "<div class='myq-content border-bottom'>\n            <div class='myq-content-hl'>\n                <div class='preface'>\n                    <span class='preface-head'>".concat(myData[i].preface, "</span>\n                    <span class='preface-num'>No.").concat(myData[i].num, "</span>\n                </div>\n                <a href=\"myqcontent.html\">").concat(myData[i].title, "</a>\n            </div>\n            <div class='myq-content-date-box'>\n                <span class='myq-content-date'>").concat(myData[i].date, "</span>\n            </div>\n            <div class='myq-content-answer-box'>\n                <button class='myq-content-answer ").concat(myData[i].answer ? '' : 'btn-dp-none', "'>\uB2F5\uBCC0\uC644\uB8CC</button>\n            </div>\n        </div>");
    }
  } else {
    for (var _i = 0; _i < maxContent; _i++) {
      tempHtml += "<div class='myq-content border-bottom'>\n            <div class='myq-content-hl'>\n                <div class='preface'>\n                    <span class='preface-head'>".concat(myData[_i].preface, "</span>\n                    <span class='preface-num'>No.").concat(myData[_i].num, "</span>\n                </div>\n                <a href=\"myqcontent.html\">").concat(myData[_i].title, "</a>\n            </div>\n            <div class='myq-content-date-box'>\n                <span class='myq-content-date'>").concat(myData[_i].date, "</span>\n            </div>\n            <div class='myq-content-answer-box'>\n                <button class='myq-content-answer ").concat(myData[_i].answer ? '' : 'btn-dp-none', "'>\uB2F5\uBCC0\uC644\uB8CC</button>\n            </div>\n        </div>");
    }
  }
...
function setPageData(data, viewPage) {
  ...
  if (endContent >= contentLength) {
    ...
    for (var _i3 = startContent; _i3 < endContent; _i3++) {
      tempHtml += "<div class='myq-content border-bottom'>\n            <div class='myq-content-hl'>\n                <div class='preface'>\n                    <span class='preface-head'>".concat(myData[_i3].preface, "</span>\n                    <span class='preface-num'>No.").concat(myData[_i3].num, "</span>\n                </div>\n                <a href=\"myqcontent.html\">").concat(myData[_i3].title, "</a>\n            </div>\n            <div class='myq-content-date-box'>\n                <span class='myq-content-date'>").concat(myData[_i3].date, "</span>\n            </div>\n            <div class='myq-content-answer-box'>\n                <button class='myq-content-answer ").concat(myData[_i3].answer ? '' : 'btn-dp-none', "'>\uB2F5\uBCC0\uC644\uB8CC</button>\n            </div>\n        </div>");
    }
  }
