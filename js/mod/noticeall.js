...
var noticeContentWrap = document.querySelector('.notice-content-wrap');
...
var noticeUrl = 'js/noticeall.json';
...
firstLoadAsync(noticeUrl, 1); // 처음 버튼 클릭시 첫 페이지로
...
function setPageData(data, viewPage) {
  ...
  if (endContent >= contentLength) {
    ...
    for (var _i3 = startContent; _i3 < endContent; _i3++) {
      tempHtml += "<div class='notice-content border-bottom'>\n            <div class='notice-content-hl'>\n                <div class='preface'>\n                    <span class='preface-head'>".concat(myData[_i3].preface, "</span>\n                    <span class='preface-num'>No.").concat(myData[_i3].num, "</span>\n                </div>\n                <a href='noticecontent.html'>").concat(myData[_i3].title, "</a>\n            </div>\n            <div class='notice-content-date-box'>\n                <span class='notice-content-date'>").concat(myData[_i3].date, "</span>\n            </div>\n        </div>");
    }
  }
